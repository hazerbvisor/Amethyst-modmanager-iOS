...
Java_dev_haze_metal_NativeBridge_nativeSubmitVertices(
    ...
    (*environment)->GetFloatArrayRegion(environment, vertices, 0, floatCount, temporary);
...
HAZE_JNI_EXPORT jlong JNICALL
Java_dev_haze_metal_NativeBridge_nativeGeneration(JNIEnv *environment, jclass bridgeClass) {
    (void)environment;
    (void)bridgeClass;
...
Java_dev_haze_metal_NativeBridge_nativeFloatCount(JNIEnv *environment, jclass bridgeClass) {
    (void)environment;
    (void)bridgeClass;
...
HAZE_JNI_EXPORT jint JNICALL
Java_dev_haze_metal_NativeBridge_nativeVertexCount(JNIEnv *environment, jclass bridgeClass) {
    (void)environment;
    (void)bridgeClass;
...
Java_dev_haze_metal_NativeBridge_nativeChecksum(JNIEnv *environment, jclass bridgeClass) {
    (void)environment;
    (void)bridgeClass;
...
Java_dev_haze_metal_NativeBridge_nativeReset(JNIEnv *environment, jclass bridgeClass) {
    (void)environment;
    (void)bridgeClass;
    HazeBridgeReset();
}
